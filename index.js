...
buttonList.forEach((element, index) => {
    element.addEventListener("click", () => {
        ...
        if (index === 2) {
            document.querySelector(".cont2").style.overflowY = "scroll"
            document.querySelector(".cont2").style.overflowX = "hidden"
        } else {
            document.querySelector(".cont2").style.overflowY = "unset"
            document.querySelector(".cont2").style.overflowX = "unset"
        }
    })
})

const arrowElem = document.getElementById("arrow")
const arrowContElem = document.querySelector(".arrow-cont")
...
arrowElem.addEventListener("click", () => {
    ...
    if (navFlag === false) {
        navElem.style.height = "51%"
        arrowElem.style.transform = "rotate(-135deg)"
        arrowElem
        navFlag = true
    } else {
        navElem.style.height = "5%"
        arrowElem.style.transform = "rotate(45deg)"
        navFlag = false
    }
...
window.onload = function () {
    document.querySelector(".pp-cont").classList.add('pp-cont-onload');
}